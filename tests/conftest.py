...
def mock_flowkit_sample(sample_channels):
    ...
    mock_sample.as_dataframe.return_value = pd.DataFrame(mock_data, columns=sample_channels)
...
def sample_extended_trajectory():
    ...
    states = [ExtendedSDEState(P=100.0 - i * 5, Ne=float(i * 10), t=float(i)) for i in range(10)]
