...
- **δ_P** — эффективная скорость функциональной инактивации ≈ 0.1 ч⁻¹ (характерное время потери сигнальной активности после дегрануляции ~10 ч; NB: биологический срок жизни циркулирующих тромбоцитов составляет 8-10 *дней*, но в ране активированные тромбоциты теряют сигнальную функцию значительно быстрее за счёт дегрануляции и клиренса)
...
**Обоснование:** Тромбоциты — первый ответ на повреждение. Их функциональная кинетика в ране описывается экспоненциальным затуханием после начального пика активации [Nurden et al., Blood Reviews 2008]. Дегрануляция α-гранул высвобождает >300 биоактивных молекул [Blair & Flaumenhaft, Blood Reviews 2009]. Параметр δ_P отражает не биологическое время жизни тромбоцита (8-10 дней в циркуляции), а эффективную скорость потери сигнальной активности в ране после дегрануляции.
...
Где:
- **r_F** — максимальная скорость пролиферации ≈ 0.03 ч⁻¹ (время удвоения ~24 ч при оптимальной PDGF-стимуляции in vitro; in vivo время удвоения первичных фибробластов составляет 40-54 ч; r_F представляет верхнюю границу при полной митогенной стимуляции, модулируемой функцией H(C_PDGF, C_TGFβ))
...
**Обоснование:** Миофибробласты — ключевые эффекторы ремоделирования и потенциальные драйверы фиброза. Их апоптоз при разрешении раны — основной механизм перехода от грануляционной ткани к рубцу [Desmoulière et al., American Journal of Pathology 1995]. Позднейшие исследования установили, что TGF-β и механический стресс действуют как сигналы выживания для миофибробластов, а их снижение запускает массовый апоптоз [Hinz, Experimental Eye Research 2016; Tomasek et al., Nature Reviews Molecular Cell Biology 2002]. Нарушение этого процесса → патологический рубец/келоид.
...
**Обоснование:** CD34+ клетки в контексте регенерации кожи обладают ограниченной пролиферацией и дифференцируются преимущественно в фибробласты и эндотелиальные клетки [Badiavas & Falanga, Archives of Dermatology 2003]. PRP стимулирует мобилизацию стволовых клеток; механизмы включают SDF-1/CXCR4 ось [Kucia et al., Leukemia 2009] и PI3K/AKT-опосредованную пролиферацию [Ranzato et al., Journal of Cellular and Molecular Medicine 2009 — показана роль Ca²⁺, P38, ERK и PI3K/AKT в PRP-опосредованной активации фибробластов].
...
**Обоснование:** TNF-α — центральный медиатор воспалительной фазы, продуцируется M1 макрофагами через NF-κB путь [Bradley, Journal of Pathology 2008]. IL-10 ингибирует NF-κB транскрипцию, снижая продукцию TNF-α [Mosser & Zhang, Immunological Reviews 2008; Fiorentino et al., J Immunol 1991]. Параметр γ_TNF = 0.5 ч⁻¹ соответствует тканевому периоду полужизни ~83 мин; плазменный t½ составляет ~20 мин (γ ≈ 2.1 ч⁻¹), но модель описывает тканевой компартмент с более медленным клиренсом.
...
**Обоснование:** IL-10 — ключевой противовоспалительный цитокин, продуцируемый преимущественно M2-макрофагами и регуляторными T-клетками [Mosser & Zhang, Immunological Reviews 2008]. Эффероцитоз (фагоцитоз апоптотических нейтрофилов) запускает противовоспалительный каскад через индукцию TGF-β1, PGE2 и PAF [Fadok et al., Journal of Clinical Investigation 1998], что способствует M2-поляризации и последующей продукции IL-10 уже M2-макрофагами [Serhan & Savill, Nature Immunology 2005]. Это критическая обратная связь: нейтрофилы → апоптоз → эффероцитоз → TGF-β1/PGE2 → M2-поляризация → IL-10 → разрешение воспаления. Терм s_IL10_efferocytosis в уравнении описывает этот опосредованный эффект.
...
**Обоснование:** VEGF-A индуцируется через HIF-1α при гипоксии — классический механизм ангиогенеза [Ferrara, Endocrine Reviews 2004]. M2-подобные макрофаги — основной клеточный источник VEGF в ране, особенно в гипоксических условиях [Ferrara et al., Nature Medicine 2003; Nucera et al., Oncogene 2011].
...
- **γ_TGF** — деградация ≈ 0.15 ч⁻¹ (t₁/₂ ~ 4-5 ч)

**Обоснование:** TGF-β — плейотропный цитокин: противовоспалительный + профибротический. Положительная обратная связь миофибробласт↔TGF-β через CTGF и механическую активацию латентного TGF-β — ключевой механизм фиброза [Leask & Abraham, FASEB Journal 2004]. Математически эта положительная обратная связь создаёт бистабильный переключатель (cp. [Vodovotz et al., Current Opinion in Critical Care 2006] для аналогичных бистабильных структур в моделях воспаления): при нарушении баланса → патологический рубец.
...
```
dC_IL8 = [(s_IL8_damage · D(t) + s_IL8_M1 · M₁ + s_IL8_Ne · Nₑ) / (1 + C_IL10/K_inhib) - γ_IL8 · C_IL8]dt + σ_IL8 · C_IL8 · dW_IL8
```
...
- **1/(1 + C_IL10/K_inhib)** — подавление продукции IL-10 через ингибирование NF-κB
- **γ_IL8** — деградация ≈ 0.5 ч⁻¹

**Обоснование:** IL-8 — ключевой рекрутёр нейтрофилов через CXCR1/CXCR2 [Kolaczkowska & Kubes, Nature Reviews Immunology 2013]. Аутокринная петля усиления — важная особенность ранней воспалительной фазы. IL-10 подавляет продукцию хемокинов через ингибирование NF-κB [Fiorentino et al., J Immunol 1991; Moore et al., Annu Rev Immunol 2001].
...
**Обоснование:** Коллаген — основной структурный белок ECM. Баланс продукции (фибробласты/миофибробласты) и деградации (MMPs) определяет исход заживления [Gill & Parks, Int J Biochem Cell Biol 2008]. Модель Michaelis-Menten для MMP-субстратной кинетики — стандарт в вычислительных моделях ECM-ремоделирования [Vempati et al., PLoS Computational Biology 2014; Xue et al., PNAS 2009 — пример мультифазной модели раневого заживления с механикой ECM].
...
**Обоснование:** Двухфазная кинетика PRP подтверждена in vitro: быстрый выброс при активации (минуты-часы) + замедленное высвобождение из фибриновой матрицы (дни) [Mazzucco et al., Vox Sanguinis 2009; Schär et al., Muscles Ligaments Tendons J 2015]. Простая экспонента не описывает этот двухфазный характер. Концентрации факторов роста в PRP варьируют в зависимости от метода приготовления; значения в таблице представляют характерные диапазоны для стандартных PRP-протоколов.
...
PEMF воздействует через несколько механизмов [Pilla, Electromagnetic Biology and Medicine 2013]:
...
Обоснование: комбинация PRP + PEMF теоретически может давать супераддитивный эффект через усиление рецепторной чувствительности PEMF-индуцированным Ca²⁺. Предварительные клинические данные о комбинированной терапии ограничены [Wang et al., Medicine 2024], но механистическое обоснование следует из независимо подтверждённых механизмов PRP (ростовые факторы) и PEMF (Ca²⁺/CaM-сигналинг [Pilla 2013]). Параметр β_synergy требует экспериментальной калибровки.
...
- **Dynamic Time Warping (DTW)** — расстояние между формами траекторий, нечувствительное к фазовым сдвигам. R² штрафует корректную форму, смещённую по времени (например, пик M1 на 6 ч раньше); DTW не штрафует. Библиотека: `dtaidistance`.
- **CRPS** (Continuous Ranked Probability Score) — стандарт probabilistic forecasting. Для гауссового приближения: CRPS = σ · [z · (2Φ(z)−1) + 2φ(z) − 1/√π], где z = (y−μ)/σ. Библиотека: `properscoring`.
...
- Метрика: `coverage_95` ∈ [0, 1] — чем ближе к 1, тем лучше калибровка.
...
- Метрика: `timing_mae_hours` — средняя ошибка обнаружения (если задан эталон).

#### 6.2.4 Kendall's τ (ранжирование чувствительности)

- Сравнивает ранги параметров по Sobol (ST) и Morris (μ*) через Kendall's τ ∈ [−1, 1].
- τ ≈ 1 → методы согласуются в определении ключевых параметров.
- Реализация: `scipy.stats.kendalltau` на пересечении parameter_names.
...
| δ_P | 0.1 | ч⁻¹ | Эффективная инактивация тромбоцитов | Модельная оценка |
...
| q_Mf | 0.015 | ед/ч | Продукция коллагена Mf | Desmoulière 1995 |
...
| τ_burst | 1-2 | ч | Быстрое высвобождение | Mazzucco 2009; Schär 2015 |
| τ_sustained | 24-72 | ч | Замедленное высвобождение | Mazzucco 2009; Schär 2015 |
...
8. Desmoulière, A. et al. (1995). Apoptosis mediates the decrease in cellularity during the transition between granulation tissue and scar. *American Journal of Pathology*, 146(1), 56-66.
...
31. Nurden, A.T. et al. (2008). Platelets and wound healing. *Frontiers in Bioscience*, 13, 3532-3548.
...
33. Ranzato, E. et al. (2009). Platelet lysate promotes in vitro wound scratch closure of human dermal fibroblasts: different roles of cell calcium, P38, ERK and PI3K/AKT. *Journal of Cellular and Molecular Medicine*, 13(8b), 2448-2454.
33a. Schär, M.O. et al. (2015). Platelet-rich concentrates differentially release growth factors and induce cell migration in vitro. *Clinical Orthopaedics and Related Research*, 473(5), 1635-1643.
33b. Tomasek, J.J. et al. (2002). Myofibroblasts and mechano-regulation of connective tissue remodelling. *Nature Reviews Molecular Cell Biology*, 3(5), 349-363.
33c. Wang, Y. et al. (2024). The combined application of pulsed electromagnetic fields and platelet-rich plasma in tissue regeneration. *Medicine*, 103(35), e39475.
...
