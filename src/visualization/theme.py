...
# ── Цвета анализа чувствительности / идентификации ────────────────

ANALYSIS_COLORS: dict[str, str] = {
    "S1": "#2e86c1",  # Sobol first-order — синий
    "ST": "#e74c3c",  # Sobol total-effect — красный
    "mu_star": "#27ae60",  # Morris mu_star — зелёный
    "sigma": "#f39c12",  # Morris sigma — оранжевый
    "influential": "#e74c3c",  # Влиятельные параметры — красный
    "threshold": "#95a5a6",  # Порог / невлиятельные — серый
    "convergence": "#2e86c1",  # Сходимость — синий
    "posterior": "#2e86c1",  # Posterior гистограмма — синий
    "ci": "#e74c3c",  # Доверительный интервал — красный
    "point_est": "#27ae60",  # Точечная оценка — зелёный
}
